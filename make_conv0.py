...
param_path = "make_file/backgroundmask"

# backgroundmaskは−１のフィルタかけて、＋１
...
if not os.path.isdir(param_path):
    os.mkdir(param_path)
np.array(w2).tofile(os.path.join(param_path, "bmask_w" + ".bin"))
np.array(b2).tofile(os.path.join(param_path, "bmask_b" + ".bin"))
